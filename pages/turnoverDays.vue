		...
		<view class="container">
			<view class="itop">
				...
				<view class="itop-time">
					<view>
						<uni-datetime-picker type="date" style="font-size: 25rpx;" @change="changeDate($event, 0)">{{startDate}}</uni-datetime-picker>
					</view>
					<view>
						<text style="font-size: 25rpx;"> 至 </text>
					</view>
					<view>
						<uni-datetime-picker :start="startDate" type="date" style="font-size: 25rpx;" @change="changeDate($event, 1)">{{endDate}}</uni-datetime-picker>
					</view>
				</view>
			</view>
			<view class="dataShow">
